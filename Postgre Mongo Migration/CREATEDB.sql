...
CREATE TABLE depositos (
    id_deposito     NUMERIC(10) PRIMARY KEY,
...
CREATE TABLE movimentacoes (
    id_movimentacao         NUMERIC(10) PRIMARY KEY,
    id_produto              NUMERIC(10),
    id_deposito NUMERIC(10),
    tipo_movimentacao CHAR(1),
    quantidade_movimentada NUMERIC(10),
    valor_unitario NUMERIC(10,2),
    valor_total_movimentado NUMERIC(10,2) GENERATED ALWAYS AS (quantidade_movimentada * valor_unitario) STORED,
...
INSERT INTO movimentacoes (id_movimentacao, id_produto, id_deposito, tipo_movimentacao, 
quantidade_movimentada, valor_unitario, data_movimentacao)
